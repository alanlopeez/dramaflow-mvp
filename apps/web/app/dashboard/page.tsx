    ...
    <div className="flex-1 flex flex-col md:flex-row w-full">
      ...
      <main className="flex-1 p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8 overflow-y-auto max-w-7xl w-full mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">Panel de Control de Minidramas</h1>
          ...
          <Link
            href="/studio/new"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-bold text-sm sm:text-base text-white bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-500 hover:to-pink-500 shadow-lg shadow-violet-600/25 transition-all active:scale-95"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
          <div className="p-4 sm:p-5 rounded-2xl glass-panel border border-white/10 space-y-2">
            ...
            <p className="text-[11px] sm:text-xs text-emerald-400 flex items-center gap-1">Persistidos en Neon PG</p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-2xl glass-panel border border-white/10 space-y-2">
            ...
            <p className="text-2xl sm:text-3xl font-black text-white">94.6%</p>
            <p className="text-[11px] sm:text-xs text-emerald-400">+12% sobre el promedio</p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-2xl glass-panel border border-white/10 space-y-2">
            ...
            <p className="text-lg sm:text-xl font-black text-white truncate">Google Cloud Storage</p>
            <p className="text-[10px] sm:text-xs text-zinc-400 truncate">gs://dramaflow-mvp-1787884887-storage</p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-2xl glass-panel border border-white/10 space-y-2">
            ...
            <p className="text-[11px] sm:text-xs text-violet-300">Plan Pro Activo</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
            ...
            <span className="text-[11px] text-zinc-500 font-mono">Sincronizado con Neon DB y Google Cloud</span>
          </div>
              ...
              >
                <div className="p-4 sm:p-5 space-y-3">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-xs px-2.5 py-1 rounded-md bg-zinc-800 text-zinc-300 font-medium truncate">
                      {project.niche}
                    </span>
                    <StatusBadge status={project.status} />
                  </div>

                  <h3 className="font-bold text-sm sm:text-base text-white group-hover:text-violet-300 transition-colors line-clamp-1">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap items-center gap-2 text-[11px] sm:text-xs text-zinc-500 pt-2 border-t border-white/5">
                ...
                <div className="p-3.5 sm:p-4 bg-black/40 border-t border-white/5 flex flex-wrap items-center justify-between gap-2">
                  <Link
                    href={`/studio/${project.id}`}
                    className="text-xs font-bold text-violet-400 hover:text-violet-300 flex items-center gap-1.5 py-1.5 min-h-[36px]"
                  >
                  ...
                  {project.videoUrl && (
                    <a
                      ...
                      className="px-3 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white text-xs font-semibold flex items-center gap-1.5 transition-colors min-h-[36px]"
                    >
        ...
        <div className="p-4 sm:p-6 rounded-2xl glass-panel-glow border border-violet-500/30 space-y-4" id="trends">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <TrendingUp className="w-5 h-5 text-pink-400 shrink-0" />
              <h2 className="text-base sm:text-lg font-bold text-white">Ganchos Virales de TikTok en Vivo (Tendencias 2026)</h2>
            </div>
            <span className="text-[11px] sm:text-xs text-pink-400 font-mono">Playwright Crawler Activo</span>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3.5 sm:gap-4">
            {TRENDING_HOOKS.map((hook, i) => (
              <div key={i} className="p-4 rounded-xl bg-zinc-900/80 border border-white/10 space-y-2 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-zinc-500 mt-1">Audio: Cinematic Hit ({hook.bpm} BPM)</p>
                </div>
                <Link
                  href="/studio/new"
                  className="mt-2 inline-flex items-center gap-1 text-xs text-violet-400 hover:text-violet-300 font-semibold pt-2 border-t border-white/5"
                >
